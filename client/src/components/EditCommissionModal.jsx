// src/components/EditCommissionModal.jsx
import { useState } from 'react';
import { FaTimes } from 'react-icons/fa';

export default function EditCommissionModal({ booking, onClose, onSave }) {
    const [amount, setAmount] = useState(booking.commissionAmount || '');
        ...
        <div className="fixed inset-0 bg-slate-900 bg-opacity-75 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md animate-slide-up">
                <div className="flex justify-between items-center mb-4">
                    <h3 className="text-lg font-bold text-slate-800">Edit Commission for: {booking.folderNo}</h3>
